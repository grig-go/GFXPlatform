 ...
 *
 * Full-page signup form for Nova with invitation and domain-based signup support.
 */
...
export function SignUpPage({ appName = 'Nova', onSignUpSuccess, onNavigateToLogin }: SignUpPageProps) {
