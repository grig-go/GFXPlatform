// Animation Engine for GFX Renderer
// Handles playback, interpolation, and timing
// Shared between Nova GFX and Pulsar GFX
...
export function getAnimatedProperties(
  ...
  phaseAnimations.forEach((anim) => {
    ...
    if (shouldDebug) {
      console.log('[Animation] time:', time, 'delay:', anim.delay, 'duration:', anim.duration, 'localTime:', localTime, 'progress:', progress);
    }
