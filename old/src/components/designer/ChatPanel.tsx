...
import { 
  ...
  AlertCircle, CheckCircle2, Code, ChevronDown, ChevronUp, Camera, X, FileText, Trash2, Mic, MicOff, Square
} from 'lucide-react';
...
import type { AIContext, AIChanges } from '@/types/ai';
...
Alternatively, check your project settings (⚙️) to configure the API key.`,
  ...
  return (
    <div className="h-full w-full min-w-0 flex flex-col bg-card border-r border-border overflow-hidden">
      {/* Header */}
