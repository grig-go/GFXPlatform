...
import {
  Save, Play, Settings, HelpCircle, User, Cpu, Palette, Bell,
  ChevronDown, Grid3X3, Wrench, FolderOpen, Sparkles,
  ExternalLink, Copy, Check, Monitor, LogOut, Keyboard,
} from 'lucide-react';
      ...
      <div className="flex items-center gap-0.5">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button 
              size="sm" 
              className="h-7 sm:h-8 px-2 sm:px-3 bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:from-violet-600 hover:to-fuchsia-600 text-white border-0"
            >
              <Play className="w-3.5 sm:w-4 h-3.5 sm:h-4 sm:mr-1.5" />
              <span className="hidden sm:inline">Preview</span>
              <ChevronDown className="w-3 h-3 ml-1 sm:ml-1.5 opacity-70" />
            </Button>
          </DropdownMenuTrigger>
