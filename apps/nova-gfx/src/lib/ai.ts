...
import type { AIContext, AIResponse, AIChanges } from '@/types/ai';
...
export const AI_MODELS = {
  ...
  'gemini-2.5-pro': {
    id: 'gemini-2.5-pro',
    name: 'Gemini 2.5 Pro',
    description: 'Most capable Gemini, best for complex designs',
  ...
  'gemini-2.5-flash': {
    ...
    description: 'Fast & smart, great balance of speed/quality',
    provider: 'gemini' as AIProvider,
  ...
  'gemini-1.5-pro': {
    id: 'gemini-1.5-pro',
    name: 'Gemini 1.5 Pro',
    description: 'Capable model with long context window',
    provider: 'gemini' as AIProvider,
  ...
  'gemini-1.5-flash': {
    ...
    description: 'Fast and efficient, simple tasks',
    provider: 'gemini' as AIProvider,
