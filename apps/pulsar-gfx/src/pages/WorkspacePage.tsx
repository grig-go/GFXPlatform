...
export function WorkspacePage() {
  ...
  const handleCreatePlaylist = async () => {
    ...
    setIsCreating(true);
    try {
      // Map 'schedule' to 'timed' for database compatibility
      const dbMode = newPlaylistType === 'schedule' ? 'timed' : newPlaylistType;
      const newPlaylist = await createPlaylist(newPlaylistName.trim(), currentProject.id, dbMode);
