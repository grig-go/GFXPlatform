...
export function Stage() {
  ...
  const rootElements = useMemo(() => {
    ...
    return elements
      .filter((e) => {
        ...
        // During full preview, only show elements from the current template
        if (isPlayingFullPreview && e.template_id !== currentTemplateId) return false;
        return true;
      })
      .sort((a, b) => {
  ...
  }, [elements, templates, layers, isPlayingFullPreview, currentTemplateId]);
