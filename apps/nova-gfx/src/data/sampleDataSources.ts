/**
 * Sample data sources for data binding feature
 */
...
export interface DataSourceConfig {
  ...
  type: string;
  subCategory?: string;
  displayField: string; // Field to show in record dropdown
...
// Weather - Current Conditions (real data from Nova agents)
...
// Weather - Daily Forecast (real data from Nova agents - structure with arrays)
