-- =============================================
-- Fix Organization Seed Data Functions - FINAL
-- Corrects all column names to match actual schema
-- =============================================
...
-- Returns TEXT for id to handle both UUID and TEXT ids
-- =============================================
...
BEGIN
  ...
  CASE p_category
    ...
    WHEN 'feeds' THEN
      -- feeds: no description column, use category instead
      RETURN QUERY
    ...
    WHEN 'data_sources' THEN
      -- data_sources: no description column, use type instead
      RETURN QUERY
    ...
    WHEN 'templates' THEN
      -- templates: no description column, use type instead
      RETURN QUERY
