    ...
    <div className="sticky top-0 z-50 border-b bg-card shadow-md px-6 py-2.5">
      <div className="flex items-center justify-between">
        ...
        >
          ...
          <div className="w-8 h-8 bg-gradient-to-br from-purple-700 to-red-600 rounded-lg flex items-center justify-center">
            <span className="text-white font-semibold text-sm">X</span>
          </div>
          <span className="text-[rgb(0,0,0)] dark:text-slate-100 font-semibold text-lg">Nexus</span>
        </div>
        ...
        <div className="flex items-center gap-1">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="relative text-[rgb(0,0,0)] dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800"
          >
            <Bell className="w-4 h-4" />
            <Badge className="absolute -top-1 -right-1 w-4 h-4 flex items-center justify-center p-0 bg-red-500 text-white border-0 text-[10px]">
              3
            </Badge>
          </Button>
        </div>
